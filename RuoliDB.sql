...
GRANT SELECT, ALTER, DELETE ON EQUIPAGGI TO standard_user;
GRANT SELECT, ALTER, DELETE ON MISSIONI TO standard_user;
GRANT SELECT, ALTER, DELETE ON ROBOT TO standard_user;
GRANT SELECT, ALTER, DELETE ON SENSORI TO standard_user;
GRANT SELECT, ALTER, DELETE ON RILEVAZIONI TO standard_user;
GRANT SELECT, ALTER, DELETE ON ANOMALIE TO standard_user;
GRANT SELECT, ALTER, DELETE ON INTERVENTI TO standard_user;
GRANT SELECT, ALTER, DELETE ON REPORT TO standard_user;
GRANT SELECT, ALTER, DELETE ON EQUIPAGGIMISSIONI TO standard_user;
GRANT SELECT, ALTER, DELETE ON ROBOTMISSIONI TO standard_user;
GRANT SELECT, ALTER, DELETE ON SENSORIMISSIONI TO standard_user;
GRANT SELECT, ALTER, DELETE ON EQUIPAGGIINTERVENTI TO standard_user';
